...
export const GERMAN: TranslationValues = {
	...
	ABOUT_PAGE: {
		...
		GREETING: 'Hällochen!   ',
		INFORMATION:
			'Mein Name ist Martin und ich bin zur zeit ein Student der Informatik auf der FH Aachen studiert',
	...
	CONTACT_PAGE: {
		...
		OTHER_INFORMATION:
			'oder kontaktiere mich über discord (Martin#6666) oder die anderen sozialen medien auf der home page'
	},
	BACK_BUTTON: 'ZURÜCK'
};
...
export const ENGLISH: TranslationValues = {
	...
	ABOUT_PAGE: {
		...
		INFORMATION:
			'My name is Martin and I am currently a student, studying computer science at FH Aachen',
	...
	CONTACT_PAGE: {
		...
		SUBMIT_BUTTON: 'send',
		OTHER_INFORMATION:
			'or contact me through discord (Martin#6666) or the other social medias given at the home page'
	},
	BACK_BUTTON: 'RETURN'
};
